...
// Stream interface that enables FileSystem.createReadStream().
class FileReader {

}

// Stream interface that enables FileSystem.createWriteStream().
class FileWriter {
...
class FileSystem {
  ...
  // TODO: alias copy() as copyFile() and copyDir().
  ...
  createWriteStream(path, options) {
    ...
    return this.rest.upload(path, (e) => {
      logger.error(e);
    });
  }
  ...
  writeSync(fd, data, position, encoding) {
    // TODO: position & encoding are optional.
    // TODO: returns int (bytes written)
  ...
  readdir(path, callback) {
    // TODO: yield list of names only (no stat info).
    // TODO: cache stat info for later stat() calls.
