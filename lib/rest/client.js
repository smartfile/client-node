...
>>>>>>> d43555c5df17a73adfd20ac1799dac2bc4274036
...
>>>>>>> d43555c5df17a73adfd20ac1799dac2bc4274036
    ...
    return this.request(options)
      .on('response', (r) => {
        // If no-one cares about the response...
        if (!callback) {
          return;
        }
  ...
  upload(p, s, callback) {
    ...
    this._uploadPost(dirname, basename, s, callback);
  }
