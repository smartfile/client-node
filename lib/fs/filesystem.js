...
class FileSystem {
  ...
  unlink(path, callback) {
    const end = OPERATION.startTimer({ opName: 'unlink' });
  ...
  rename(src, dst, callback) {
    return operationWrapper(this.rest, 'rename', [src, dst], callback);
  }
